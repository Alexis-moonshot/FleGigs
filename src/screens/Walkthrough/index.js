...
class Walkthrough extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      slide: [
        ...
        {key: 2, image: Images.image2, title: 'Find helpers near around'},
        {key: 3, image: Images.image3, title: 'Pay to your helpers'},
        {
          key: 4,
          image: Images.image4,
  ...
  render() {
    ...
    return (
      <LinearGradient start={{x: 0, y: 1}} end={{x: 1, y: 0}} colors={['#5574F7', '#60C3FF']} style={{flex: 1}}>
        ...
        <ScrollView
          ...
          <View style={styles.buttonGroup}>
            ...
            <Button full style={{marginTop: 20}} loading={this.state.loading} onPress={() => navigation.navigate('SignIn')}>
              Sign In
            </Button>
